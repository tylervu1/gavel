...
# If needed, you can also create SRTF policies with performance or packing enhancements
class SRTFPolicyWithPerf(Policy):
    def __init__(self, packing=False):
        self._name = 'SRTF_Perf'
        self._packing = packing
        self._policy = SRTFPolicy(packing=packing)
...
class SRTFPolicyWithPacking(PolicyWithPacking):
    def __init__(self, packing_threshold=1.5):
        ...
        self._policy = SRTFPolicy(packing_threshold=packing_threshold)
